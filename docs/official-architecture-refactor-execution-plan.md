...
> This document records the implementation history of the ChatWithMe-2 architecture refactor.
> The original planning sections (Objectives, Key References, Execution Phases 0-4) from the
> initial design were completed in early 2026 and have been archived. What follows is the
> implementation history starting from 2026-02-27.
...
| `builtin_chart_template` | `src/demos/chat/builtin-tools/chart-template.ts` | engine+type → format spec lookup (added in AI chart selection refactor) |
